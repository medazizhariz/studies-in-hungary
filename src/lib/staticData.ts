...
export const STATIC_UNIVERSITIES: StaticUniversity[] = [
  ...
  },
  {
    ...
    faculties: ['Faculty of Medicine', 'Faculty of Dentistry', 'Faculty of Pharmacy', 'Faculty of Science and Technology', 'Faculty of Economics and Business', 'Faculty of Law', 'Faculty of Engineering'],
  ...
  },
  {
    ...
    faculties: ['Faculty of Medicine', 'Faculty of Science and Informatics', 'Faculty of Law and Political Sciences', 'Faculty of Humanities and Social Sciences', 'Faculty of Economics and Business Administration', 'Faculty of Pharmacy'],
    ...
    facultyLinks: [
      ...
      { name: 'Faculty of Law and Political Sciences', url: 'https://jgypk.u-szeged.hu' },
      { name: 'Faculty of Economics and Business', url: 'https://eco.u-szeged.hu/english' },
    ],
    avg_rating: 4.2,
    review_count: 3,
    reviews: [
  ...
  },
  {
    ...
    faculties: ['Medical School', 'Faculty of Law', 'Faculty of Humanities', 'Faculty of Sciences', 'Faculty of Business and Economics', 'Faculty of Engineering and Information Technology', 'Faculty of Health Sciences'],
  ...
  },
  {
    ...
    faculties: ['Faculty of Engineering Sciences', 'Faculty of Information Engineering', 'Faculty of Architecture, Civil Engineering and Transport Sciences', 'Faculty of Economics and Business Administration', 'Faculty of Law and Political Sciences'],
    ...
    facultyLinks: [
      ...
      { name: 'Faculty of Economics', url: 'https://sze.hu/en/faculties/faculty-of-economics' },
    ],
    avg_rating: 4.1,
    review_count: 3,
    reviews: [
  ...
  },
  {
    ...
    faculties: ['Faculty of Mechanical Engineering and Informatics', 'Faculty of Materials Science and Engineering', 'Faculty of Economic Sciences', 'Faculty of Law', 'Faculty of Earth Sciences and Engineering', 'Faculty of Arts'],
    ...
    facultyLinks: [
      ...
      { name: 'Faculty of Economic Sciences', url: 'https://www.uni-miskolc.hu/en/faculties/gti' },
  ...
  },
  {
    ...
    faculties: ['Faculty of Forestry', 'Faculty of Wood Engineering and Creative Industries', 'Faculty of Geomatics and Civil Engineering', 'Benedek Elek Faculty of Pedagogy', 'Faculty of Economics'],
    programs: ['Forestry', 'Wood Technology', 'Geomatics', 'Pedagogy', 'Economics', 'Creative Arts and Design'],
    degree_levels: ['Bachelor', 'Master', 'PhD'],
    languages: ['Hungarian', 'English', 'German'],
    ...
    facultyLinks: [
      ...
      { name: 'Faculty of Wood Engineering', url: 'https://uni-sopron.hu/en/faculties/faculty-of-wood-engineering/' },
      { name: 'Faculty of Geomatics', url: 'https://uni-sopron.hu/en/faculties/faculty-of-geomatics/' },
    ],
    avg_rating: 4.0,
    review_count: 3,
    reviews: [

      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 h-14 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-2 shrink-0">
          ...
          <div className="leading-tight hidden sm:block">
            <div className="text-xs font-black text-gray-900">Studies in</div>
          ...
          {user ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors text-sm font-semibold text-gray-700">
          ...
          {NAV_LINKS.map(({ href, label }) => (
            <Link key={href} href={href}
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium ${
                pathname.startsWith(href) ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:bg-gray-50'
              }`}>
              {label}
            </Link>
          ))}
